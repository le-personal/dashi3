...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  // 'get /api/v1/storage/:source/data': 'DataController.index',
  // 'get /api/v1/storage/:source/data/:id': 'DataController.get',
  // 'post /api/v1/storage/:source/data': 'DataController.post',
